    ...
    <Layout>
      <section className="container py-20 grid md:grid-cols-2 gap-16 max-w-6xl">
        <div>
          ...
          <h1 className="font-serif text-5xl mb-6">Vamos conversar.</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 bg-secondary/30 p-8">
          ...
          <button className="w-full bg-gold-gradient text-primary-foreground py-4 uppercase tracking-[0.25em] text-xs font-semibold hover:opacity-90 transition-opacity">
            Enviar mensagem
          </button>
        </form>
      </section>
